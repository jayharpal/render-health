...
export const _userFeeds: IUserProfilePost[] = [...Array(3)].map((_, index) => ({
  id: _mock.id(index),
  ...
  author: {       // Add author property
    id: _mock.id(11),  // Replace with actual author ID
    avatarUrl: _mock.image.avatar(11), // Replace with actual author avatar URL
    name: _mock.fullName(11), // Replace with actual author name
  },
