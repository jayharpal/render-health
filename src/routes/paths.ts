...
export const paths = {
  ...
  dashboard: {
    ...
    savingsCard: {
      ...
      pancard: {
        root: `${ROOTS.DASHBOARD}/savings-card/pancard`,
        manage: `${ROOTS.DASHBOARD}/savings-card/pancard/manage`,
        review: `${ROOTS.DASHBOARD}/savings-card/pancard/review`,
      },
      payment: `${ROOTS.DASHBOARD}/savings-card/payment`,
      pendingRequests: `${ROOTS.DASHBOARD}/savings-card/pending-requests`,
      rebate: {
        root: `${ROOTS.DASHBOARD}/savings-card/rebate`,
        manage: `${ROOTS.DASHBOARD}/savings-card/rebate/manage`,
        review: `${ROOTS.DASHBOARD}/savings-card/rebate/review`,
      },
      ...
      tariff: {
        root: `${ROOTS.DASHBOARD}/savings-card/tariff`,
        update: `${ROOTS.DASHBOARD}/savings-card/tariff/update`,
