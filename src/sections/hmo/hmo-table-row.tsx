  ...
  return (
    <>
      <TableRow>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row?.enrollee}</TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row?.facilities}</TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row?.billsClaims}</TableCell>
