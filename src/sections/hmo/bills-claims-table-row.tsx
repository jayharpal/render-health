...
export default function BillsClaimsTableRow({ row, onEditRow }: Props) {
  ...
  return (
    <>
      <TableRow>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row?.dateReceived}</TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row?.authorizationCode}</TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row?.hospitalLabs}</TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row?.enrolleeName}</TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row?.requested}</TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row?.approved}</TableCell>
