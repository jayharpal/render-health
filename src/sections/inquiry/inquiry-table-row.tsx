...
export default function InquiryTableRow({ row, sr_no, onEditRow }: Props) {
  const { name, status, email, mobile_no, availability, role_preference } = row;
  ...
  return (
    <>
      <TableRow>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{sr_no}</TableCell>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{availability}</TableCell>

        <TableCell sx={{ whiteSpace: 'nowrap' }}>{role_preference}</TableCell>
