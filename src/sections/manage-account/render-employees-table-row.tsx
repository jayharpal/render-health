  ...
  return (
    <>
      <TableRow>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row?.employeeId}</TableCell>
        ...
        <TableCell>
          <Label
            variant="soft"
            color={
              (row?.status === 'Active User' && 'success') ||
              (row?.status === 'Inactive User' && 'error') ||
              'default'
            }
          >
            {row?.status}
      ...
      <AddRenderEmployeeManageAccess open={create.value} onClose={create.onFalse} />
