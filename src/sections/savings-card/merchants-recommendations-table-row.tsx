  ...
  return (
    <>
      <TableRow>
        ...
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row?.facilityType}</TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row?.handler}</TableCell>
        <TableCell sx={{ whiteSpace: 'nowrap' }}>{row?.suggestedBy}</TableCell>
