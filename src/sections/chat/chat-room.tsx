...
import { IUsers, ChatMessage, Sender } from 'src/types/chat';
...
export default function ChatRoom({ singleParticipant, participants, conversation }: Props) {
  ...
  const attachments = uniq(flatten(conversation.map((messages) => messages.files)));
  ...
  const renderToggleBtn = (
    <Tooltip title={lgUp && !collapseDesktop ? "Collapse" : "Expand"} placement='left'>
      <IconButton
